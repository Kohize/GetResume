...
export default function Showcase() {
  return (
    <div className="min-w-5xl">
      <div className="grid grid-cols-2 justify-center bg-linear-to-r from-purple-500 via-indigo-500 to-blue-500 p-10 items-center justify-items-center rounded-lg gap-x-10">
        <div className="rounded-lg bg-gray-100 py-5 px-10 min-w-lg text-lg min-h-50">
        ...
        <div className="rounded-lg bg-gray-100 py-5 px-10 min-w-lg min-h-50 text-md">
