...
export default function Hero() {
  return (
    <section className="p-20 bg-gray-200 flex flex-col items-center">
      <div>
        ...
        <div className="flex gap-x-5 justify-center mb-15">
          <Link
            className="border-1 border-indigo-600 rounded-md p-2 text-indigo-600 font-semibold  hover:bg-indigo-600 hover:text-white"
            to={'resume'}>
            Start Building
          </Link>
          <Link
